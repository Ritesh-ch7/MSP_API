...
def no_shot_body_template(ticket_id,requestor_name,description,priority,severity,trace_id:str = None):
    """
    Generates the subject for an email using a prompt template.
    ...
    Returns:
    str: The generated email subject based on the prompt template.

    Raises:
    HTTPException: If an error occurs during subject generation,
